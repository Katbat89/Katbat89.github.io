...
//nav menu fade
$(".nav").click(function (){
  $(".nav"). toggleClass('special')
  $("span").click(function(e) {
    e.stopPropagation();
});
});

//Submenu rortaing titles
$(document).ready(function(){
  timeout();
  var time = 0;
function timeout() {
    setTimeout(function () {
      if(time===0){
      $(".textInfo").html("<h2>Currently Reading</h2> <br> Chi no Wadachi - <em>Shuzo Oshimi</em>");
      $(".textInfo2").html("<h2>Squad Up With Me On PS5</h2><p>KatBat89</p>");
      $(".textInfo").addClass("animate__animated animate__fadeInDown");
      time++;
    }else
      if(time===1){
      $(".textInfo").html("<h2>Currently Reading</h2> <br> The Sympathizer - <em>Viet Thanh Nguyen</em>");
      time++;
    }else
      if(time===2){
    ...
    if(time===3){
    $(".textInfo").html("<h2>Currently Playing </h2> <br>Baldur's Gate");
    time=0;
    }
        timeout();
    }, 6000);
  ...
  function myFunction1() {
    var x = document.getElementById("profile-info1");
    if (x.style.display === "none") {
      x.style.display = "block";
    } else {
      x.style.display = "none";
  ...
  function myFunction2() {
    var x = document.getElementById("profile-info2");
    if (x.style.display === "none") {
      x.style.display = "block";
    } else {
      x.style.display = "none";
  ...
  function myFunction3() {
    var x = document.getElementById("profile-info3");
    if (x.style.display === "none") {
      x.style.display = "block";
    } else {
      x.style.display = "none";
